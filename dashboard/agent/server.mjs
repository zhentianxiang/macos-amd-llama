...
const catalog = [
  ...
  },
  {
    ...
    sizeLabel: "约 7.2 GB",
    description: "推荐用于 12 GB 显存的多模态模型",
    multimodal: true,
    ...
    artifacts: [
      ...
      {
        file: "mmproj-gemma-4-12b-it-qat-q4_0.gguf",
        size: 175115616,
  ...
  },
  {
    ...
    sizeLabel: "约 15.6 GB",
    description: "高性能多模态 MoE，需使用系统内存分担",
    multimodal: true,
    mmproj: "mmproj-gemma-4-26B-it.gguf",
    artifacts: [
      {
        file: "gemma-4-26B_q4_0-it.gguf",
        size: 14439363584,
      ...
      {
        file: "mmproj-gemma-4-26B-it.gguf",
        size: 1194828160,
        sha256: "a359953a076b877db30c31dbbb4c6d93b4a6e017ee5db5784247e4d4c0dd4f3b",
        url: "https://huggingface.co/google/gemma-4-26B-A4B-it-qat-q4_0-gguf/resolve/main/gemma-4-26B-it-mmproj.gguf",
      },
    ],
  },
  {
    id: "gemma4-31b-qat-q4",
    name: "Gemma 4 31B · QAT Q4_0",
    file: "gemma-4-31B_q4_0-it.gguf",
    sizeLabel: "约 18.9 GB",
    description: "旗舰多模态模型，需使用系统内存分担",
    multimodal: true,
    mmproj: "mmproj-gemma-4-31B-it.gguf",
    artifacts: [
      {
        file: "gemma-4-31B_q4_0-it.gguf",
        size: 17651001568,
      ...
      {
        file: "mmproj-gemma-4-31B-it.gguf",
        size: 1200726368,
        sha256: "6bd60bdb958548b4093196d38744b0f2290c12503a3fddd7486bffa9c5eb07a4",
        url: "https://huggingface.co/google/gemma-4-31B-it-qat-q4_0-gguf/resolve/main/gemma-4-31B-it-mmproj.gguf",
      },
    ],
  },
  {
